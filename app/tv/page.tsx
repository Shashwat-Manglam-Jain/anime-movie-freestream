...
export default function TvPage() {
  ...
  useEffect(() => {
    ...
    fetchShows(1, tab, searchQuery, false);
  }, [tab, searchQuery, fetchShows]);

  // Pagination
  useEffect(() => {
    if (page > 1 && !usingFallback) {
      fetchShows(page, tab, searchQuery, true);
    }
  }, [page, tab, searchQuery, usingFallback, fetchShows]);
    ...
    <div className="mx-auto max-w-7xl px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Browse and stream TV shows — powered by TMDB
        </p>
      </div>
